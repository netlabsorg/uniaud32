...
#if IS_MODULE(CONFIG_SND_HDA_CODEC_HDMI) || defined(CONFIG_SND_HDA_CODEC_HDMI)
		mod = "snd-hda-codec-hdmi";
#endif
		break;
	case HDA_CODEC_ID_GENERIC:
#if IS_MODULE(CONFIG_SND_HDA_GENERIC) || defined(CONFIG_SND_HDA_GENERIC)
...
#if IS_ENABLED(CONFIG_SND_HDA_GENERIC) || defined(CONFIG_SND_HDA_GENERIC)
