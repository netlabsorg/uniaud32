	...
	const struct component_master_ops *ops)
{
	...
	list_for_each_entry(m, &aggregate_devices, node, struct aggregate_device)
	...
	struct component_match_array *mc)
{
	...
	list_for_each_entry(c, &component_list, node, struct component) {
...
static int try_to_bring_up_masters(struct component *component)
{
	...
	list_for_each_entry(adev, &aggregate_devices, node, struct aggregate_device) {
		if (!adev->bound) {
