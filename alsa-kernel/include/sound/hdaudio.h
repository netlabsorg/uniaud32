...
#else
	volatile __le32 *buf;		/* virtual address of CORB/RIRB buffer */
#endif
...
#else
	volatile void __iomem *ppcap;
	volatile void __iomem *spbcap;
	volatile void __iomem *mlcap;
	volatile void __iomem *gtscap;
	volatile void __iomem *drsmcap;
#endif
	/* codec linked list */
...
#else
	volatile __le32 *posbuf;		/* position buffer pointer */
#endif
