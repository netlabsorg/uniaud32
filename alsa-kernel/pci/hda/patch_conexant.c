...
#ifdef TARGET_OS2
#define KBUILD_MODNAME "patch_conexant"
#endif
...
static const struct hda_verb CXT_FIXUP_GPIO1_VERBS[] = {
...
static const struct hda_pintbl CXT_FIXUP_TOSHIBA_P105_PINS[] = {
...
#else
		.v.pins = CXT_FIXUP_HEADPHONE_MIC_PIN_PINS
#endif
	},
	[CXT_FIXUP_HEADPHONE_MIC] = {
		.type = HDA_FIXUP_FUNC,
...
#else
		.v.pins = CXT_FIXUP_TOSHIBA_P105_PINS,
#endif
	},
	[CXT_FIXUP_HP_530] = {
		.type = HDA_FIXUP_PINS,
